...
$process = Get-Process -Name "Depot Agents" -ErrorAction SilentlyContinue
if ($process) {
    Write-Info "Closing Depot Agents..."
...
Write-Host ""
Write-Host "  Depot Agents has been installed."
Write-Host ""

...
const EXPECTED_CHANNELS: string[] = [
  ...
  'agentState:getObservationHistory',
  'agentState:queryKnowledgeEntities',
  'agentState:queryKnowledgePatterns',
  'agentState:setObservationPaused',
  'agentState:triggerConsolidation',
  'agentState:triggerObservation',

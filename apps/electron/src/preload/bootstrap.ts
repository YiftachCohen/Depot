...
import { createCallbackServer } from '@depot/shared/auth/callback-server'
import { CHATGPT_OAUTH_CONFIG } from '@depot/shared/auth/chatgpt-oauth-config'
import {
...
import type { ConfirmDialogSpec, FileDialogSpec } from '@depot/server-core/transport'

...
import { Icon_Home, Icon_Folder, Spinner } from '@depot/ui'

import * as storage from '@/lib/local-storage'
import { extractWorkspaceSlugFromPath } from '@depot/shared/utils/workspace-slug'
...
import { Tooltip, TooltipContent, TooltipTrigger } from '@depot/ui'
import {
  DropdownMenu,
  DropdownMenuTrigger,
  DropdownMenuSub,
...
import { type ThinkingLevel, THINKING_LEVELS, getThinkingLevelName } from '@depot/shared/agent/thinking-levels'
...
const DEFAULT_PLACEHOLDERS = [
  ...
  'Type @ to mention files, folders, or agents',
  ...
  const connectionsByProvider = React.useMemo(() => {
    ...
    for (const conn of llmConnections) {
      ...
      if (provider === 'anthropic' || provider === 'anthropic_compat' || provider === 'bedrock' || provider === 'vertex') {
        ...
        groups['Depot Backend'].push(conn)
      }
    }

...
import type { StatusConfig } from '@depot/shared/statuses'
import { isEmoji } from '@depot/shared/utils/icon-constants'
import { resolveEntityColor, getDefaultStatusColor } from '@depot/shared/colors'
import type { EntityColor } from '@depot/shared/colors'

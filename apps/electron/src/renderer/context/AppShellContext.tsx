...
export interface AppShellContextType {
  ...
  labels?: import('@depot/shared/labels').LabelConfig[]
  ...
  onSendMessage: (sessionId: string, message: string, attachments?: FileAttachment[], skillSlugs?: string[], badges?: import('@depot/core').ContentBadge[], modelOverride?: string) => void

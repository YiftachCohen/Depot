...
import { TurnCard, type ActivityItem } from '@depot/ui'
...
const inputContainerSampleLabels: LabelConfig[] = [
  ...
  { id: 'sprint', name: 'Sprint', color: { light: '#D97706', dark: '#F59E0B' }, valueType: 'string' },
]
...
function InputContainerPlayground({
  disabled = false,
  isProcessing = false,
  placeholder = 'Message Depot Agent...',
  ...
  },
  {
    ...
    props: [
      ...
      },
      {
        ...
        defaultValue: 'Message Depot Agent...',
      },
      {
        name: 'currentModel',

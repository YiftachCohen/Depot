...
import { getNetworkProxySettings, setNetworkProxySettings } from '@depot/shared/config/storage';
import type { NetworkProxySettings } from '@depot/shared/config/types';

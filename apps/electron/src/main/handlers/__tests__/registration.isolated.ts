...
async function getExpectedChannels(): Promise<Set<string>> {
  ...
  const [
    ...
    import('@depot/server-core/handlers/rpc/labels'),
    import('@depot/server-core/handlers/rpc/llm-connections'),
    import('@depot/server-core/handlers/rpc/llm-generation'),
    import('@depot/server-core/handlers/rpc/oauth'),
    import('@depot/server-core/handlers/rpc/sessions'),
    import('@depot/server-core/handlers/rpc/settings'),
    import('@depot/server-core/handlers/rpc/skills'),
    import('@depot/server-core/handlers/rpc/sources'),
    import('@depot/server-core/handlers/rpc/statuses'),
    import('@depot/server-core/handlers/rpc/system'),
    import('@depot/server-core/handlers/rpc/workspace'),
    import('@depot/server-core/handlers/rpc/onboarding'),
  ])
  ...
  return new Set([
    ...
    ...llmGeneration.HANDLED_CHANNELS,
...
describe('RPC handler registration', () => {
  ...
  it('keeps onboarding channels in registration coverage', async () => {
    const { HANDLED_CHANNELS } = await import('@depot/server-core/handlers/rpc/onboarding')
    const { registerAllRpcHandlers } = await import('../index')

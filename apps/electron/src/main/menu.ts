 ...
 * Includes only relevant items for the Depot app.
 *
 ...
 *
 * On Windows/Linux: Menu is hidden - all functionality is in the Depot logo menu.
...
export async function rebuildMenu(): Promise<void> {
  ...
  // Users access menu via the Depot logo dropdown in the app
  if (!isMac) {
  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    ...
    ...(isMac ? [{
      ...
      submenu: [
        ...
        { type: 'separator' as const },
        { role: 'hide' as const, label: 'Hide Depot' },
        { role: 'hideOthers' as const },
        { role: 'unhide' as const },
        { type: 'separator' as const },
        { role: 'quit' as const, label: 'Quit Depot' }
      ]
    }] : []),
      ...
      submenu: [
        {
          ...
          click: () => shell.openExternal('https://depot.do/docs')
        },
        {

...
mock.module('@depot/shared/workspaces', () => ({
  loadWorkspaceConfig: () => ({
    defaults: {
      permissionMode: 'ask',
      thinkingLevel: 'medium',
...
mock.module('@depot/shared/agent/backend', () => ({
...
mock.module('@depot/shared/sources', () => ({
...
mock.module('@depot/shared/automations', () => ({
...
mock.module('@depot/shared/sessions', () => ({
  listSessions: () => [],
...
const { SessionManager } = await import('@depot/server-core/sessions')

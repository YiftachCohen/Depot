...
This guide explains how to configure sources (MCP servers, APIs, local filesystems) in Depot Agent.
...
**Available guides:** GitHub, Linear, Slack, Gmail, Google Calendar, Google Drive, Google Docs, Google Sheets, Outlook, Microsoft Calendar, Teams, SharePoint, Depot, Filesystem, Brave Search, Memory
...
- "To find issues in the Depot iOS project: ..."
...
User: Issue tracking for my iOS team, project called "Depot iOS"
...
Agent: [Creates config.json with:
        ...
        - tagline: "Issue tracking for the Depot iOS team"
        - OAuth authentication]
Agent: [Writes guide.md mentioning "Depot iOS" project and iOS team context]
...
Agent: Linear is now set up! I've configured it to focus on the "Depot iOS" project.
You can use it to:
- Search and view issues in Depot iOS

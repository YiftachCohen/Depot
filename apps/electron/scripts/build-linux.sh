...
echo "=== Building Depot Agents AppImage (${ARCH}) using electron-builder ==="
if [ "$UPLOAD" = true ]; then
...
# electron-builder outputs: Depot-Agent-x86_64.AppImage or Depot-Agent-aarch64.AppImage
BUILT_APPIMAGE_NAME="Depot-Agent-${LINUX_ARCH}.AppImage"
...
# Rename to our standard naming convention: Depot-Agent-x64.AppImage, Depot-Agent-arm64.AppImage
APPIMAGE_NAME="Depot-Agent-${ARCH}.AppImage"

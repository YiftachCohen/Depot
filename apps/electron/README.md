# Depot Agents Electron App

The primary desktop interface for Depot Agents, built with Electron + React. Provides a multi-session inbox with chat interface for interacting with Claude via Depot workspaces.
...
- **Subagent support** - Load and apply agent definitions from Depot documents

#!/usr/bin/env bun
/**
 * craft-cli — Terminal client for Depot Agent server.
 *
 * Connects over WebSocket (ws:// or wss://) to a running Depot Agent server
...
function printHelp(): void {
  process.stdout.write(`craft-cli — Terminal client for Depot Agent server

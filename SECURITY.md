...
We take security seriously. If you discover a security vulnerability in Depot, please report it responsibly.

### How to Report

**Please do NOT report security vulnerabilities through public GitHub issues.**

Instead, please send an email to: **security@depot.do**
...
- The Depot desktop application
- The `@depot/*` npm packages
- Official Depot repositories

...
import type { Workspace } from '@depot/core/types'
import type { StoredAttachment, AnnotationV1 } from '@depot/core/types'
import type { PermissionMode } from '@depot/shared/agent/mode-types'
import type { ThinkingLevel } from '@depot/shared/agent/thinking-levels'
import type { AuthResult } from '@depot/shared/agent'
import type {
  Session,
  SessionStatus,

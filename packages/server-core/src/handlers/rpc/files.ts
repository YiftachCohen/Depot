...
import { RPC_CHANNELS, type FileAttachment } from '@depot/shared/protocol'
import type { StoredAttachment } from '@depot/core/types'
import { readFileAttachment, validateImageForClaudeAPI, IMAGE_LIMITS } from '@depot/shared/utils'
import { getSessionAttachmentsPath, validateSessionId } from '@depot/shared/sessions'

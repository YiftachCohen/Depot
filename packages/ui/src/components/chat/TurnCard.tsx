...
import type { ToolDisplayMeta, AnnotationV1 } from '@depot/core'
import { normalizePath, pathStartsWith, stripPathPrefix } from '@depot/core/utils'
...
function clearAnnotationMarks(root: HTMLElement): void {
  ...
  annotatedInlineCodeNodes.forEach((codeNode) => {
    ...
    codeNode.style.boxShadow = '' // eslint-disable-line craft-styles/no-nonstandard-shadows
  })

 ...
 * Depot Agent's AgentEvent format for UI compatibility.
 *
...
import type { AgentEvent as CraftAgentEvent } from '@depot/core/types';
import type {
...
/**
 * Maps Pi SDK events to Depot AgentEvents for UI compatibility.
 *
 * Event mapping:
...
export class PiEventAdapter extends BaseEventAdapter {
  ...
  /**
   * Adapt a Pi SDK event to zero or more Depot AgentEvents.
   */

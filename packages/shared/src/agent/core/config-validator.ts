...
/**
 * Depot Agent specific config files that have known schemas.
 */
...
export class ConfigValidator {
  ...
  /**
   * Check if a file path is a Depot Agent config file.
   *
   * @param filePath - Path to check
   * @returns true if this is a Depot Agent config
   */

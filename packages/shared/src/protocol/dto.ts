 ...
 * Extracted here so handler code in @depot/server-core can import
 * from @depot/shared/protocol without reaching into the app.
 */
...
export { generateMessageId } from '@depot/core/types'
...
export interface Session {
  ...
  /** Skill slug that created this session (tracks origin for skill-initiated sessions) */
  skillSlug?: string
}
...
export interface WorkspaceSettings {
  ...
  enabledSourceSlugs?: string[]
  /** Which skills appear on the dashboard. undefined = show all (backward compat) */

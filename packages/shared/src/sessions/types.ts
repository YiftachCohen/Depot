...
import type { StoredAttachment, MessageRole, ToolStatus, AuthRequestType, AuthStatus, CredentialInputMode, StoredMessage } from '@depot/core/types';
 ...
 * Re-exported from @depot/core for convenience
 */
export type { StoredMessage } from '@depot/core/types';

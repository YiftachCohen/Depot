 ...
 * with contextual understanding of valid Depot MCP URL patterns.
 */
...
const SYSTEM_PROMPT = `You are a URL validator for Depot MCP servers. Your ONLY job is to validate if a URL is a valid Depot MCP URL.

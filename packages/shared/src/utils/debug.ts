// Check DEPOT_DEBUG env var at module load (for SDK subprocess), with CRAFT_DEBUG fallback
// Guard against browser/renderer contexts where process is undefined
let debugEnabled = typeof process !== 'undefined' && (process.env?.DEPOT_DEBUG === '1' || process.env?.CRAFT_DEBUG === '1');

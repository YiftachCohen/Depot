...
const BLOCKED_ENV_VARS = [
  // Depot Agent auth (set by the app itself)
  'ANTHROPIC_API_KEY',
 ...
 * Both DepotMcpClient (remote MCP sources) and ApiSourcePoolClient (API sources) implement this.
 */

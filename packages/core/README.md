...
Shared TypeScript types and utilities for Depot applications.
...
// Import utilities
import { generateMessageId, debug } from '@depot/core';
```
...
- `AgentEvent` - Events from DepotAgent
